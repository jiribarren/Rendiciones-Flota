...
export default function DetalleRendicionJefaturaPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-900">Detalle de Mi Rendición</h1>
        </div>
      </header>
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={saving}
                className="flex-1 bg-purple-600 text-white py-3 rounded-lg disabled:opacity-50"
              >
