...
import { ArrowLeft, Image, Search, Filter } from 'lucide-react'

export default function ListaRendicionesAdmin() {
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">Todas las Rendiciones</h1>
          </div>
        </div>
      </header>
                ...
                {rendicionesFiltradas.length === 0 ? (
                  ...
                  rendicionesFiltradas.map((rendicion) => (
                    <tr key={rendicion.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <Link
                          href={`/admin/rendicion/${rendicion.id}`}
